    ...
    <div id="header">
        <div id="sub">
          <div class="centered-image top-left-corner">
            <a href="index.html">
              <img src="https://lwheel.github.io/FILESMO/EAMO.png" alt="EAMO" style="width: 100px; height: 77px;">
            </a>
          </div>
        </div>
...
<dl class="normal">
<dt><a href="http://www.artofproblemsolving.com/">Art of Problem Solving</a></dt>
<dd>Offers problem-solving resources and online classes.</dd>

<dt><a href="http://www.mathlinks.ro/Forum/portal.php">Mathlinks</a></dt>
<dd>Provides forums, a large community, and a wealth of resources.</dd>


<dt><a href="https://www.globtalent.org/">Global Talent Network</a></dt>
<dd>Offers opportunities, support, and a vibrant community.</dd>

<dt><a href="https://www.global-talent.org/resource-map">Global Talent Lab</a></dt>
<dd> A resource page for college scholarships.</dd>
...
'''
    ...
    output_filename = os.path.join(output_directory, f"links.html")
