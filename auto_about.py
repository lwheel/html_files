...
<h2 style="text-align:left; margin-left: 30px;">About {acro}</h2>

<dl class="normal">
    <dt style="text-align:left; margin-left: 40px;"><h2>{site_name}</h2></dt>
    <dd>
        <p>
           {intro}
          </p>
    ...
    <br>
    <br>
<dt style="text-align:left; margin-left: 40px;"><a href = "dummy.pdf">{acro} Regulations</a></dt>
<dd>This document contains the official procedures and rules for the {site_name}.</dd>
...
'''
    ...
    output_filename = os.path.join(output_directory, f"about.html")
